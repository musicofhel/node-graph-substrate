...
export const LfStageCard = memo(({ id }: { id: string }) => {
  ...
  return (
    <div className={`w-[210px] rounded border ${borderOverride} bg-neutral-900 shadow-md`}>
      <Handle type="target" position={Position.Top} id="target-top" className="!w-2 !h-2 !bg-neutral-600 !border-none" />
      <Handle type="target" position={Position.Left} id="target-left" className="!w-2 !h-2 !bg-neutral-600 !border-none" />
      ...
      <Handle type="source" position={Position.Bottom} id="source-bottom" className="!w-2 !h-2 !bg-neutral-600 !border-none" />
      <Handle type="source" position={Position.Right} id="source-right" className="!w-2 !h-2 !bg-neutral-600 !border-none" />
    </div>
  );
});
